...
class Recipient(models.Model):
    ...
    # Аннотации для линтера
    email: models.EmailField
    full_name: models.CharField
    comment: Optional[models.TextField]
    owner: Optional[models.ForeignKey[User, models.Model]]
...
class Message(models.Model):
    ...
    # Аннотации для линтера
    theme_message: models.CharField
...
class Mailing(models.Model):
    ...
    message: models.ForeignKey["Message", models.Model]
    recipients: models.ManyToManyField["Recipient", models.Model]
    owner: Optional[models.ForeignKey[User, models.Model]]
    ...
    def mass_update_statuses(cls, user=None):
        ...
        ).update(status=cls.STATUS_FINISHED)
...
class MailingAttempt(models.Model):
    ...
    # Аннотации для линтера
    mailing: models.ForeignKey["Mailing", models.Model]
    recipient: models.ForeignKey["Recipient", models.Model]
    server_response: Optional[models.TextField]
    status: models.CharField
    error_message: Optional[models.TextField]
